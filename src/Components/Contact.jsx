            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-4">
                  <div className={`w-10 h-10 rounded-full border ${accentColors[accentColor]} flex items-center justify-center`}>
                  ...
                  <div>
                    ...
                    <p className="text-gray-200">john@doe.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-200">Neo Tokyo, Digital District</p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex gap-4">
                  {socialLinks.map((link) => (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      onMouseEnter={() => uiSounds.hover.play()}
